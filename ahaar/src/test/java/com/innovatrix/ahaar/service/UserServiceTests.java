...
class UserServiceTest {
    ...
    void getUsers_ShouldReturnPagedUsers() {
        // Arrange
        ApplicationUser user = new ApplicationUser(1L, "John", "john@example.com", "password123");
    ...
    void updateUser_ShouldUpdateExistingUser() {
        ...
        ApplicationUser user = new ApplicationUser(userId, "John", "john@example.com", "password123");
